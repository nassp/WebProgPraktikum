 ...
 * service he has to call this class. It registers important services by
 * default!
 * 
 * @author Patrick Na§
 */
public class ServiceManager {
	...
	/**
	 * singleton "constructor": register some default services in a specific
	 * order!
	 */
	public void init() {
		try {
			...
			throw new RuntimeException(
					"Service Manager: unable to start default services! Reason "
							+ e.toString());
		}
	}
	...
	public void registerService(String interfaceName, IService service) {
		...
		if ((interfaceName != null) && (service != null)) {
			...
			throw new RuntimeException(
					"Service Manager: unable to register service "
							+ interfaceName);
		}
	}
	 ...
	 *            the interface of the service we want to get
	...
	public <T> T getService(Class<T> serviceInterface) {
		...
		if (serviceMap.containsKey(serviceInterface.getSimpleName())) {
			...
			if (serviceMap.get(serviceInterface.getSimpleName()) != null) {
				...
				return serviceInterface.cast(serviceMap.get(serviceInterface
						.getSimpleName()));
			}
		}

		throw new RuntimeException(
				"Service Manager: unable to get requested service "
